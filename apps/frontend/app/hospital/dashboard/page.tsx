...
export default function HospitalDashboard() {
  ...
  const handleVerify = async (
    ...
    try {
      ...
      setActionMsg({
        type: "success",
        text: `Claim ${decision === "verified" ? "verified" : "rejected"} successfully`,
      });
      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-500 text-sm mt-0.5">
            Review and verify patient claims assigned to your hospital
          </p>
        </div>
        ...
        {claims.length === 0 ? (
          <div className="bg-white border border-gray-200 rounded-md py-16 text-center">
            ...
            <p className="text-gray-500 font-medium">No claims to verify</p>
            <p className="text-gray-400 text-sm mt-1">
              Claims will appear here when ATB sends them for hospital
              verification
            </p>
          </div>
        ) : (
