export const en = {
  ...
  howItWorks: {
    ...
    description: 'A clear experience from becoming a member to receiving support when needed.',
    step1: 'Choose your protection',
    step1Desc: 'Join in minutes with one simple annual membership and clear benefits.',
    step2: 'Stay assured',
    step2Desc: 'Your protection stays active for 12 months — support is there when you need it.',
    step3: 'Get the care you need',
    step3Desc: 'Receive financial support for eligible hospital stays through a simple process.',
  },
  eligibility: {
    ...
    rule2Copy: 'Treatment support applies when an eligible hospital stay is at least 24 hours.',
    rule3Title: 'Up to 12,000 BDT yearly',
    rule3Copy: 'Your available annual support reduces only as eligible treatment bills are used.',
    rule4Title: 'Document-led review',
    rule4Copy: 'Keep hospital and treatment documents ready for the review process.',
  ...
  modal: {
    ...
    paymentMethod: 'The bKash/nagad number you sent money from',
    processingPayment: 'Processing...',
    sendingOtp: 'Sending OTP...',
    verifyingOtp: 'Verifying...',
    errorOccurred: 'An error occurred. Please try again.',
    tryAgain: 'Dismiss',
    applicationReceived: 'Your membership information has been saved successfully.',
    ...
    benefits: 'Receive 12,000 BDT membership benefits against your paid 1,000 BDT.',
  },
  aboutChairman: {
